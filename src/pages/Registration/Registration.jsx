    ...
    <div>
      <form>
        <Box  display="flex" 
         ...
         <Typography variant="h5" padding={3} textAlign="center">Registration</Typography>
         ...
         <Button sx={{margin:3,borderRadius:3}}variant="contained" color="warning">Register</Button>
        </Box>
      </form>
    </div>
    )
